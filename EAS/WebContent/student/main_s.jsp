			...
			<div class="col-md-3 column">
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<a href="../student/liststudent.jsp" target="main">学生信息管理</a>
					</div>
					<div class="panel-footer">
						<a href="../cs/addcs.jsp"  target="main">选课</a>
					</div>
					<div class="panel-footer">
						<a href="../cs/listcs.jsp"  target="main">查看已选课程</a>
					</div>
					<div class="panel-footer">
